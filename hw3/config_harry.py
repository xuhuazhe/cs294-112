...
def soft_Q_in_env():
    ...
    FLAGS.method_name = tag + 'enduro_' + str(FLAGS.dataset_size) + '_' + str(FLAGS.bad_portion) + '_' + str(
        FLAGS.soft_Q_alpha)
...
def torcs_DQFD_inenv_stage_2_simple(key):
    ...
    FLAGS.lr_schedule = PiecewiseSchedule([
        ...
        (1e7 / 2, 5e-5)],
        outside_value=5e-5)
    FLAGS.ckpt_path = ckpt_list_bad[
        key]  # '/data/hxu/cs294-112/hw3/link_data/torcs_dqfd_full_demo_30_2017-07-05 21:24:15.244307'
    FLAGS.inenv_finetune = True
...
def torcs_V_grounding_inenv_stage_2(key):
    ...
    FLAGS.ckpt_path = ckpt_list[
        key]  # '/backup/hxu/modelRL/torcs_dqfd_full_demo_stage_1_30_2017-08-04 11:39:00.926601_300000'
    FLAGS.inenv_finetune = True
...
ckpt_list_complex = {
    'dqfd': '/backup/hxu/modelRL/torcs_dqfd_full_demo_stage_1_complex_30_2017-08-09 16:45:17.873451_300000',
...
def torcs_V_grounding_inenv_stage_2_large_replay_complex(key):
    ...
    FLAGS.lr_schedule = PiecewiseSchedule([
        ...
        (1e7, 5e-5)],
        outside_value=5e-5)
    FLAGS.ckpt_path = ckpt_list_complex[
        key]  # '/backup/hxu/modelRL/torcs_dqfd_full_demo_stage_1_30_2017-08-04 11:39:00.926601_300000'
    FLAGS.inenv_finetune = True
...
ckpt_list_supermulti = {
    'dqfd': '/backup/hxu/modelRL/torcs_dqfd_full_demo_stage_1_supermulti_30_2017-08-23 11:58:42.559185_300000',
...
def torcs_V_grounding_inenv_stage_2_supermulti(key):
    ...
    FLAGS.lr_schedule = PiecewiseSchedule([
        ...
        (1e7, 5e-5)],
        outside_value=5e-5)
    FLAGS.ckpt_path = ckpt_list_supermulti[
        key]  # '/backup/hxu/modelRL/torcs_dqfd_full_demo_stage_1_30_2017-08-04 11:39:00.926601_300000'
    FLAGS.inenv_finetune = True
...
ckpt_list_bad = {
    'dqfd': '/backup/hxu/modelRL/torcs_dqfd_full_demo_stage_1_autoback_simple_bad_30_2017-08-30 20:02:52.805614_300000',
